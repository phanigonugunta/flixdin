...
<div class="px-5 rounded-3xl">
    <div class="bg-yellow-200 shadow-xl py-3 px-5 rounded-3xl">
        ...
        <div class="p-1">
            ...
            <div class="flex flex-row bg-yellow-500 p-2 rounded-3xl mt-4">
            ...
            <div class="text-center my-3 mt-5">
                <a class="text-md text-white bg-yellow-500 p-1 px-7 py-2 rounded-2xl hover:underline hover:text-yellow-600 font-medium" href="#">Edit Profile</a>
            </div>
